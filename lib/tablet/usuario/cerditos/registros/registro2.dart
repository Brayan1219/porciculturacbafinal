...
class registro2_tablet extends StatelessWidget {
  final int idhembra;
  registro2_tablet(this.idhembra);

  @override
  Widget build(BuildContext context) {
    print("id cerdita: $idhembra");
    return regis2(idhembra);
  }
}

class regis2 extends StatefulWidget {
  final int idhembra;
  regis2(this.idhembra);

  @override
  State<regis2> createState() => _regis2State(idhembra);
}

class _regis2State extends State<regis2> {
  final int idhembra;
  _regis2State(this.idhembra);
                            ...
                            child: Positioned(
                              ...
                              child: TextButton(
                                onPressed: () {
                                  ...
                                  addRegistroMacho(id, nombre, fechaIngreso, fechaNacimiento, peso,id_hembra);

                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => registro1_tablet()),
                                  );
                                },
